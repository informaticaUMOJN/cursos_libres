    ...
    <div id="DivContenido">
        <div class="row">
            ...
            <div class="col-sm-12 offset-sm-0 col-md-10 offset-md-2">
                    <input type="button" id="Regresar" name="Regresar" value="Regresar" class="btn btn-primary"  onclick="location.href='gridPagoCL.php';" />
                </div>
        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        ...
                        if ($msEstudiante != "")
                        {
                            ...
                            $msConsulta = "select ALUMNO_REL, NOMBRES_200, APELLIDOS_200 from UMO200A order by NOMBRES_200, APELLIDOS_200 desc"; 
                        ...
                        <div id="dvPG">
                            <table id="dgPG" data-options="iconCls:'icon-edit', toolbar:'#tbPG', footer:'#ftPG', singleSelect:true, method:'get', fitColumns:true">
                               ...
                               $mDatos = fxMostrarPorPago($msCodigo, $msMatricula); 
                                ...
                                {
                                    echo ("<tr data-cobro='" . $mFila["COBRO_REL"] . "' data-matricula='" . $mFila["MATCURSO_REL"] . "'>");
                                    echo ("<td>" . $mFila["PAGO_REL"] . "</td>");
                                    echo ("<td>" . $mFila["DESC_130"] . "</td>");
                                    echo ("<td>" . $mFila["DESCUENTO_142"] . "</td>");
                                    echo ("<td>" . $mFila["VALOR_142"] . "</td>");
                                    echo ("</tr>");
                                }
                                ?>  
                                </tbody>
